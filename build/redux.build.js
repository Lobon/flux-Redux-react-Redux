...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateInputVal = function updateInputVal(val) {
		(0, _jquery2.default)("#example").children('input').val(val);
	};
	...
	(0, _jquery2.default)("#example").delegate("a", "click", function () {
		action.apply((0, _jquery2.default)(this));
	});
